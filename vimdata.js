...
window.CHARACTER_DEFS = [
  ...
  },
  {
    ...
    name: 'ClaudeMan',
    nameJa: 'ClaudeMan',
    desc: 'Claude AI搭載。/think で2倍ダメージ。@tools で3方向弾。World 5制覇で解放。',
    color: '#ff8c42',
    bgColor: '#2d1500',
    ...
    passiveId: 'xp_ai',
    ultimate: { name:'AI Overdrive', cmd:'ss', desc:'全敵へAIターゲットロック、3秒間攻撃2倍' },
    unlockReq: 5,
  },
  {
    id: 'swordsman',
    name: 'Swordsman',
    nameJa: '剣士',
    desc: '剣特化の超攻撃型。斬撃波で遠距離攻撃、ため斬りで必殺一撃。World 8制覇で解放。',
    color: '#ffcc44',
    bgColor: '#2a1800',
    ...
    ultimate: { name:'居合斬り零式', cmd:'ss', desc:'画面全体を切り裂く超高速居合、瞬間5倍ダメージ' },
    unlockReq: 8,
  },
  {
    id: 'warrior',
    name: 'Warrior',
    nameJa: '戦士',
    desc: 'HP・DEF最高の不動の盾。World 15制覇 または プレミアムで解放。',
    color: '#dd4422',
    bgColor: '#2d0800',
    hp: 52, atk: 4, def: 4, spdMul: 0.85,
    jumpMul: 0.9,
    specialCmds: ['sword','charge','dd'],
    weaponTypes: ['melee'],
    passive: '防御時ダメージ-60% / 剣攻撃5倍ダメージ',
    passiveId: 'tank',
    ultimate: { name:'不動の壁', cmd:'ss', desc:'全ダメージ無効化シールド5秒+カウンター爆発' },
    unlockReq: 15,
  },
  {
    id: 'mage',
    name: 'Mage',
    nameJa: '魔術師',
    desc: '禁断の魔法使い。プレミアム限定解放。HP低いが魔法威力は最高峰。',
    color: '#8844cc',
    bgColor: '#1a0033',
    ...
    weaponTypes: ['staff'],
    passive: '浮遊(ジャンプ滞空時間UP) / 魔法弾4倍威力',
    passiveId: 'float_magic',
    ultimate: { name:'終末魔法 Ω', cmd:'ss', desc:'画面全体に超巨大魔法陣展開、全敵に即死級ダメージ' },
    unlockReq: 999,
  },
  {
    id: 'archer',
    name: 'Archer',
    nameJa: 'アーチャー',
    desc: '最速の狙撃手。World 20制覇 または プレミアムで解放。',
    color: '#44bb44',
    bgColor: '#001a00',
    ...
    weaponTypes: ['ranged'],
    passive: '射撃速度2倍 / 矢貫通(最大3体)',
    passiveId: 'rapid_pierce',
    ultimate: { name:'千本矢', cmd:'ss', desc:'画面全体に100本の矢を降らせるエリア攻撃' },
    unlockReq: 20,
  },
  // ── 新キャラクター ───────────────────────────────────────────────
  {
    ...
    name: 'Ninja',
    nameJa: '忍者',
    desc: '影の暗殺者。World 12制覇で解放。高速かつ回避率最高、影分身で敵を翻弄。',
    color: '#445566',
    bgColor: '#060812',
    hp: 20, atk: 2, def: 0, spdMul: 1.45,
    jumpMul: 1.2,
    specialCmds: ['dd','ss','yy','cc'],
    weaponTypes: ['melee','ranged'],
    passive: '回避率+40% / 背後からの攻撃に3倍ダメージ',
    passiveId: 'shadow',
    ultimate: { name:'影分身の術', cmd:'ss', desc:'3体の影分身を生成し一斉攻撃、敵陣混乱' },
    unlockReq: 12,
  },
  {
    id: 'hacker',
    name: 'Hacker',
    nameJa: 'ハッカー',
    desc: 'コードで世界を制す。LinuxBattle30章クリアで解放。全敵を一括デバッグ。',
    color: '#00ff88',
    bgColor: '#001a0a',
    hp: 22, atk: 1, def: 0, spdMul: 1.0,
    jumpMul: 1.0,
    specialCmds: ['grep','rm','sudo','dd','yy'],
    weaponTypes: ['all'],
    passive: 'コード解析で弱点ダメージ+30% / sudo時ATK×3',
    passiveId: 'code_exploit',
    ultimate: { name:'rm -rf /', cmd:'ss', desc:'画面上の全敵を強制終了(即死)、ボスには超ダメージ' },
    unlockReq: null,
    unlockCondition: 'lb30', // LinuxBattle 30チャプタークリア
  },
  {
    id: 'monk',
    name: 'Monk',
    nameJa: '僧侶',
    desc: '聖なる癒し手。World 20制覇で解放。回復と防御の要、チームのHP全回復。',
    color: '#ffeeaa',
    bgColor: '#1a1400',
    hp: 40, atk: 0, def: 3, spdMul: 0.9,
    jumpMul: 1.0,
    specialCmds: ['yy','cc','spell','bless'],
    weaponTypes: ['staff'],
    passive: '毎秒HP+1回復 / 被ダメージ時DEF比で軽減',
    passiveId: 'holy_regen',
    ultimate: { name:'神聖爆発', cmd:'ss', desc:'HP全回復+聖光AOEで全敵に大ダメージ、無敵3秒' },
    unlockReq: 20,
  },
  {
    id: 'berserker',
    name: 'Berserker',
    nameJa: 'バーサーカー',
    desc: '狂気の戦神。スポンサー限定解放。HP減少でATK爆増、理性を捨てた純粋暴力。',
    color: '#ff2222',
    bgColor: '#200000',
    hp: 60, atk: 5, def: 0, spdMul: 0.9,
    jumpMul: 0.85,
    specialCmds: ['dd','ZZ','charge','ss'],
    weaponTypes: ['melee'],
    passive: 'HP50%以下でATK×2倍 / HP10%以下でATK×5倍',
    passiveId: 'berserk_rage',
    ultimate: { name:'狂戦士の怒り', cmd:'ss', desc:'HPをすべて消費し10秒間ATK×10+無敵+猛攻撃' },
    unlockReq: 999,
    unlockCondition: 'sponsor',
  },
];
